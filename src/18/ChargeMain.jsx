...
export default function ChargeMain() {
  ...
  const getDataFetch = async() => {
    ...
    const keyword = `&zscode=${zscodeRef.current.value}&kind=${kindRef.current.value}&numOfRows=10&pageNo=1&dataType=JSON`
